...
def default_registry(*, ollama_enabled: bool | None = None, omniroute_enabled: bool | None = None, hermes_enabled: bool | None = None, deerflow_enabled: bool | None = None) -> RuntimeRegistry:
