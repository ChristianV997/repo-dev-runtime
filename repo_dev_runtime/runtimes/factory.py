...
def default_registry(*, ollama_enabled: bool | None = None, aider_enabled: bool | None = None, omniroute_enabled: bool | None = None, hermes_enabled: bool | None = None, deerflow_enabled: bool | None = None, openclaw_enabled: bool | None = None) -> RuntimeRegistry:
    return RuntimeRegistry({
        "ollama": OllamaRuntime(enabled=ollama_enabled),
        "aider": AiderRuntime(enabled=aider_enabled),
